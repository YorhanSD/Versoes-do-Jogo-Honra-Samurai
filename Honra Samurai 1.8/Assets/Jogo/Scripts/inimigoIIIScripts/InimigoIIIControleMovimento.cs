...
public class InimigoIIIControleMovimento : MonoBehaviour
{
    public float velocidade = 15f;
    public Slider chamarVida;
    public int distanciaDoPlayerNoEixoX = 20, distanciaDoPlayerNoEixoY = 20;
    ...
    void Update()
    {   
        chamarSendoAtacado = GetComponent<InimigoIIIControleAtaque>().sendoAtacado; //pega o componente "atacando" no script "InimigoAtributosDeAtaque"
        chamarPodeAtacar = GetComponent<InimigoIIIControleAtaque>().podeAtacar; //pega o componente "podeAtacar" no script "InimigoIIIAtaque"
        chamarVida = GetComponent<InimigoIIIControleDano>().vida; //pega o componente "vida" no script "inimigoIIIControleDeDano"
