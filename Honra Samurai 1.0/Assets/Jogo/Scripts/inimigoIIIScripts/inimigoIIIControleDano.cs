...
public class inimigoIIIControleDeDano : MonoBehaviour
{
    ...
    public IEnumerator mudaCor()
    {
        ...
        {
            inimigoIII.GetComponent<inimigoIIIMovimento>().sprite.color = Color.red; //Pega o componente "sprite.color" do script do "inimigoIIIMovimento" e deixa o inimigo 3 vermelho
            yield return new WaitForSeconds(0.3f);
            inimigoIII.GetComponent<inimigoIIIMovimento>().sprite.color = Color.white; //Pega o componente "sprite.color" do script do "inimigoIIIMovimento" e deixa o inimigo 3 branco
        }
    }
