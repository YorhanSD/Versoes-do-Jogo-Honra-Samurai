...
public class cmControleMovimento : MonoBehaviour
{
    ...
    {   
        ...
        chamarAtacando = GetComponent<cmControleAtaque>().atacando;  
        chamarSendoAtacado = GetComponent<cmControleDano>().sendoAtacado;
