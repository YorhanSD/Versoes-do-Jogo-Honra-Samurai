...
public class playerControleDano : MonoBehaviour
{
    ...
    void Start()
    {
     ...
     IEnumerator recarregar()
     {
         while (energia.value <= 100)//Sempre que a energia for menor que 100 então:
         {
            ...
            energia.value += 10;//Valor da energia ganha 10 pontos
         }
     }
     public IEnumerator atualizaDano()
     {
    ...
    {
        AS.clip = somSofrendoDano;//Som ao sofrer dano
        AS.Play();//Iniciar som de dano 
        ...
        GameObject.FindObjectOfType<playerControleAtaque>().sendoAtacado = true;
