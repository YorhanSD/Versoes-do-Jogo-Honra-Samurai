...
public class bl_Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    [Header("Settings")]
    [SerializeField, Range(1, 100)]private float Radio = 100;//the ratio of the circumference of the joystick
    ...
    //valor era 5
    private float radio { get { return (Radio * 0 + Mathf.Abs((diff - CenterReference.position.magnitude))); } }
